...
shinyServer(function(input, output, session, clientData) {
                ...
                if (sPrevious != sMarxanDir)
                {
                    if (sSelectDb != "")
                    {
                        ...
                        #if (sdisplaywhat == "map")
                        {
                            ...
                            updateNumericInput(session, "refreshmap", value = irefreshinput)
                        }
                        #if (sdisplaywhat == "cluster")
                        {
                            # trigger a refresh of the cluster
                            irefreshcluster <<- irefreshcluster + 1
                            updateNumericInput(session, "refreshcluster", value = irefreshinput)
                        }
                    }
                }
            }
    ...
    observe ({
        ...
        if (USER$Logged == TRUE)
        {
            ...
            {
                sdisplaywhat <<- input$displaywhat
    ...
    observe ({
        ...
        cat(paste0("input$refreshinput change sdisplaywhat ",sdisplaywhat,"\n"))
