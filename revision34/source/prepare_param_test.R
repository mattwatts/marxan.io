...
RunMarxan_paramtest_1st <- function(sParam,sDatabasePath,sShinyDataPath,iCores,iRepsPerCore)
{
    rRampBLMmin <- 0
    ...
    withProgress(message="Run parameter tests",value=0,
    {
        swhichparam <- sParam
        
        withProgress(message=swhichparam,value=0,
        {
            if (swhichparam == "BLM")
            {
