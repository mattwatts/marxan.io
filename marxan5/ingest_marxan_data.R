...
{
  #dir.create(paste0(sTempPath,"/",sUserName))
  #sPath <- CreateTempDir(paste0(sTempPath,"/",sUserName))
  sPath <- sTempPath
  ...
  # ignore any .shp.xlm files if they are present
...
PrepareCluster_compute <- function(sMarxanDir)
{
  ...
  save(sol.mds,plotlabels,nmdscolours,d,file=sRdata)
}

FirstRunMarxan <- function(sDatabasePath,sShinyDataPath,iCores,iRepsPerCore)
{
  #multicore:::detectCores()

  # detect cores on windows
  ...
  #file.copy(paste0(sShinyDataPath,"/MarOpt_v243_Linux64"),paste0(sDatabasePath,"/MarOpt_v243_Linux64"))
  #file.copy(paste0(sShinyDataPath,"/MarOpt_v243_Mac64"),paste0(sDatabasePath,"/MarOpt_v243_Mac64"))
